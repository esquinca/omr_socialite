      ...
      <form class="form-horizontal" id="loginform" name="loginform" method="POST" action="http://{{ isset($_GET['sip']) ? $_GET['sip'] : '' }}:9997/login">
        <div class="form-group  m-t-20">
          ...
          <div class="information-hidden">
            ...
            <input class="form-control" type="text" id="sip" name="sip" value="{{ isset($_GET['sip']) ? $_GET['sip'] : '172.200.0.2' }}" />
            <input class="form-control" type="text" id="mac" name="mac" value="{{ isset($_GET['mac']) ? $_GET['mac'] : '38ff361d5110' }}" />
            <input class="form-control" type="text" id="client_mac" name="client_mac" value="{{ isset($_GET['client_mac']) ? $_GET['client_mac'] : '3ca06729f541' }}" />
            <input class="form-control" type="text" id="uip" name="uip" value="{{ isset($_GET['uip']) ? $_GET['uip'] : '172.200.5.184' }}" />
            <input class="form-control" type="text" id="ssid" name="ssid" value="{{ isset($_GET['ssid']) ? $_GET['ssid'] : 'OMR-Demo' }}" />
            <input class="form-control" type="text" id="vlan" name="vlan" value="{{ isset($_GET['vlan']) ? $_GET['vlan'] : '1' }}" />
